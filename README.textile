...
Install the plugin: 
*<code>script/plugin install git://github.com/gzminiz/awesome_email.git</code>*
...
* Your CSS file must be inside of <code>/public/stylesheets</code> if you only supply the file name
* Your CSS can be anywhere in /public if you supply the relative path.
